...
public class QuantityMeasurementTest {
    ...
    @Test
    public void Uc5_given1YardAnd36Inches_WhenCompared_ShouldReturnTrue() {
    ...
    @Test
    public void Uc5_given1YardAnd3Feet_WhenCompared_ShouldReturnTrue() {
        QuantityMeasurementApp yard = new QuantityMeasurementApp(1.0, Unit.LengthUnit.YARD);
    ...
    @Test
    public void Uc5_given1FootAnd12Inches_WhenCompared_ShouldReturnTrue() {
